...
{
	(void)dst; (void)dstDev; (void)src; (void)srcDev; (void)count; (void)stream;
	return cudaErrorNotSupported;
}
cudaError_t cudaMemset(void *d, int v, size_t n)
{
	(void)d; (void)v; (void)n;
	return cudaErrorNotSupported;
}
...
/* Stream management                                                    */
/* ------------------------------------------------------------------ */
cudaError_t cudaStreamCreate(void **s)
{
	if (s) *s = 0;
	return cudaErrorNotSupported;
}
...
{
	(void)fptr; (void)grid; (void)block; (void)args; (void)shmem; (void)stream;
	return cudaErrorNotSupported;
}
...
{
	(void)fptr; (void)bs; (void)dynSmem; (void)flags;
	if (num) *num = 0;
	return cudaErrorNotSupported;
}

/* ------------------------------------------------------------------ */
/* CUDA 12 internal fat-binary / module registration (ABI stubs)       */
/* ------------------------------------------------------------------ */

/* Called by CUDA 12 device-code init path before any kernel launch.
 * Real signature: unsigned long long __cudaInitModule(void **fatCubinHandle)
 * Returns 0 to signal "no-op / not initialised". */
unsigned long long __cudaInitModule(void **handle)
{
	(void)handle;
	return 0;
}

/* Real signature: void** __cudaRegisterFatBinary(void *fatCubin) */
...
/* Real signature: void __cudaRegisterFatBinaryEnd(void **fatCubinHandle) */
void __cudaRegisterFatBinaryEnd(void **handle)
{
	(void)handle;
}

/* Real signature: void __cudaUnregisterFatBinary(void **fatCubinHandle) */
void __cudaUnregisterFatBinary(void **handle)
{
	(void)handle;
}

/* Real signature (simplified – enough for the linker): */
void __cudaRegisterFunction(void **handle, const void *hostFun,
                            void *deviceFun, const void *deviceName,
                            int threadLimit, void *tid, void *bid,
                            void *bDim, void *gDim, int *wSize)
{
	(void)handle; (void)hostFun; (void)deviceFun; (void)deviceName;
	(void)threadLimit; (void)tid; (void)bid; (void)bDim; (void)gDim; (void)wSize;
}
